...
/**
 * UltimateShop compatibility check. Ensures our ASM hook targets still exist in upstream releases.
 */
public class UltimateShopCompatibilityTest {
  ...
  private static final String PRICES_CLASS =
      "cn.superiormc.ultimateshop.objects.items.prices.ObjectPrices";
  ...
  public void checkMethodSignatures() throws Exception {
    ...
    if (!Files.exists(jarPath)) {
      System.out.println(
          "UltimateShop.jar not found, skip compatibility check in local environment.");
      return;
    }
