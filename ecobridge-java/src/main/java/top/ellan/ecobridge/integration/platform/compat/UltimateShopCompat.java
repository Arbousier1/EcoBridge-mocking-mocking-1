...
public final class UltimateShopCompat {
    ...
    public static String resolveProductId(Object item) {
        ...
        Object displayObj = invokeMethod(item, "getDisplayItem", new Class<?>[]{org.bukkit.entity.Player.class}, new Object[]{null});
    ...
    private static Object invokeMethod(Object target, String methodName, Class<?>[] argsTypes, Object[] args) {
        if (target == null) return null;
        try {
